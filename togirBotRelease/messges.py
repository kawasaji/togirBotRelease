admin_text = "🐷 <b>Возможности админов группы:</b>"\
             ...
             "\n/len (text) - узнать длину сообщения"\
             "\n/get - получить айди чата"\
             "\n/getId (reply) - получить айди пользователя на которого вы ответили"\
             "\n/getMessageId (reply) - получить айди сообщения на которого вы ответили"

update = "Togir Bot Update 11.07.2022\n" \
         "\nДобавлены рп командыДобавлена реакция на добавления бота в группу" \
         "\nДобавлена реакция на добавления пользователя в группу" \
         "\nДобавлена реакция на смену аватарки группы" \
         "\nБот стал поддерживать сразу три префикса: '/', '.', '!'"